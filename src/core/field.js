...
// Признак «это уже готовый источник, а не параметры для него». Раньше эту
// роль играло имя: add() смотрел на наличие id. Имя источника при этом никто
// не читал — оно существовало ради одной этой проверки, да ещё и раздавалось
// счётчиком на всю вкладку, из-за чего нумерация зависела от порядка запуска
// уровней. Признак честнее назвать признаком.
const WELL = Symbol('well')
